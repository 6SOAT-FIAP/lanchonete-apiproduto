...
public class CadastroAcompanhamento {
    ...
    @When("envio uma requisição POST para {string} com os dados do acompanhamento")
    ...
    @Then("o código de resposta deve ser {int} para criação do acompanhamento")
